...
const GeoLayout wf_dl_MainAreaRoom_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -2401, -327, -1414, wf_dl_Cube_006_mesh),
			...
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -2087, -327, -153, wf_dl_Cube_012_mesh),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3566, -327, -1124, wf_dl_Cube_013_mesh),
			...
			GEO_TRANSLATE_NODE_WITH_DL(1, -1300, 1421, -691, wf_dl_Cube_016_mesh_layer_1),
			...
			GEO_TRANSLATE_NODE_WITH_DL(1, 1362, 1421, -493, wf_dl_Cube_019_mesh_layer_1),
			...
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -1411, 710, -4035, wf_dl_IceSaw_011_mesh),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -1437, 813, -4518, wf_dl_IceSaw_012_mesh),
