...
const LevelScript level_wf_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_ICELEVEL_TRAPDOOR, trapdoor_geo), 

	AREA(1, wf_area_1),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_WF, 0x02, 0x0B, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 9411, 1451, -1438, 0, 0, 0, 0x000B0000, bhvWarp),
		OBJECT(MODEL_ICELEVEL_TRAPDOOR, 9411, 1651, -1238, 0, 0, 0, 0x00000000, bhvTrapdoor),
		OBJECT(MODEL_NONE, 9351, 1334, -38, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 9351, 1334, -38),
